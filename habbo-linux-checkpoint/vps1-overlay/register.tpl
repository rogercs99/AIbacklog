...
<script src="{{ site.staticContentPath }}/web-gallery/static/js/registration.js" type="text/javascript"></script>
    <script type="text/javascript">		
        ...
        L10N.put("register.message.captcha_js_form", "<div><div id='recaptcha_image' class='register-label'><img id='captcha' src='{{ site.sitePath }}/captcha.jpg?t={{ randomNum }}&register=1' alt='' width='200' height='60' /></div><div class='register-label' id='captcha-reload'><img src='{{ site.staticContentPath }}/web-gallery/v2/images/shared_icons/reload_icon.gif' width='15' height='15' /> <a href='#'>{{ locale.register_i_can_t_read_the_code_please_give_me_another_one|escape('js') }}</a></div><div class='register-label'><label for='register-captcha-bubble'>{{ locale.register_type_in_the_security_code_shown_in_the_image_above|escape('js') }}</label></div><div class='register-input'><input type='text' name='bean.captchaResponse' id='register-captcha-bubble' class='register-text-black' value='' size='15' /></div></div>");
